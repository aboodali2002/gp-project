              ...
              {activeTab === "vesting" && (
                <div className="space-y-6">
                  <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                    <h3 className="font-semibold text-blue-900 mb-2">Vesting Schedule</h3>
                    <div className="text-sm text-blue-800">
                      <p><strong>Vesting Period:</strong> 48 months</p>
                      <p><strong>Vesting Method:</strong> Monthly</p>
                    ...
                    {partners.map((partner) => (
                      <div key={partner.id} className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="text-sm text-gray-600 mb-3">
                          Total Equity: {partner.totalEquity.toFixed(1)}% | 
                          Monthly Vesting: {(partner.totalEquity / 48).toFixed(2)}%
                        </div>
                        <div className="space-y-2">
                          {[12, 24, 36, 48].map((month) => (
                            <div key={month} className="flex justify-between items-center">
                              ...
                              <span className="font-medium">
                                {((partner.totalEquity * month) / 48).toFixed(1)}% vested
                              </span>
                            </div>
                          ))}
                        </div>
